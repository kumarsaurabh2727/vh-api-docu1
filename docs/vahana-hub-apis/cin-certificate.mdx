...
|**RESPONSE**|This parameter stores the status of a request as follows:<br/><ul><li>**I:**<br/>This value specifies that the API successfully returns the details of the CIN certificate.</li></ul><br/><ul><li>**E:**<br/>This value specifies that the API fails to return the details of the CIN certificate.|
