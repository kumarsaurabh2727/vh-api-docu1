...
|--------|-----------|
|**source_type**|This parameter stores any of the following values:<br/><br/><ul><li>**url_image:**<br/>This value specifies that the request contains the **URL** string as an input value.</li></ul><br/><br/><ul><li>**Base64_image:**<br/>This value specifies that the request contains the **Base64** string as an input value.</li></ul>|
...
|Name of Parameter|Description|
|------|------|
|**RESPONSE**|This parameter stores the status of the request as follows:<br/><ul><li>**I:**<br/>This value specifies that the API successfully returns the details of the GST certificate.</li></ul><br/><br/><ul><li>**E:**<br/>This value specifies that the API fails to return the details of the GST certificate.</li></ul>
|**RESPONSE_MSG**|This parameter stores any of the following response messages:<br/><ul><li>**Success:**<br/>This value specifies that the API successfully returns the details of the GST certificate.</li></ul><br/><br/><ul><li>**Error Message:**<br/>The **RESPONSE_MSG** parameter stores the error message if the API fails to return the details of the GST certificate.</li></ul>|
|**DATA**|This parameter, as a JSON type object, stores the complete details of GST certificate such as address, date of liability, date of issue of certificate, GST number, legal name, trade name, validity of the certificate, etc.|

To see the GST Certificate API's request and response samples, [click here](docs\samples\gst-certificate-sample.mdx).