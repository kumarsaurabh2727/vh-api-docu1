...
* Only captures the required and necessary details of the PAN card
...
|**Source_type**|	This parameter stores any of two following values:<br/><ul><li>**url_image:**<br/>This value specifies that the **PAN_card_ocr** API receives the PAN card image in the URL string.</li></ul><br/><br/><ul><li>**Base64_image**<br/>This value specifies that the **PAN_card_ocr** API receives the PAN card image in the Base64 string.</li></ul>|
...
|Name of Parameter|Description|
|-------|-------|
|**RESPONSE**|This parameter stores the status of the request as follows:<br/><ul><li>**I:**<br/>This value specifies that the API successfully returns the details of the PAN card.</li></ul><br/><br/><ul><li>**E:**<br/>This value specifies that the API fails to return the details of the PAN card.</li></ul>
|**RESPONSE_MSG**|This parameter stores any of the following response messages:<br/><ul><li>**Success:**<br/>This value specifies that the API successfully returns the details of the PAN card.</li></ul><br/><br/><ul><li>**Error Message:**<br/>The **RESPONSE_MSG** API stores the error message if the API fails to return the details of the PAN card.</li></ul>|
|**DATA**|This JSON object stores the complete information of PAN card holder in the form of key/value pair. The PAN card information includes:<br/><ul><li>**Name of PAN card holder**</li><li>**Father’s name**</li><li>**Date of birth of PAN card holder**</li><li>**Document no**</li><li>**PAN number**, etc.</li></ul>|
...
To see the PAN Card API's request and response samples, [click here](docs\samples\pan-card-sample.mdx)
